...
export const historyManImages = [
  '/historyman_standing.webp',
  '/historyman_crossed.webp',
...
export const yoshDialogue = [
  'Alright, History-Man, I’m here to take back what you’ve stolen. Hand over Josh’s work history, starting with his latest role at Ford!',
  "Impessive... but I know there's more. What came before that? Tell me about Sion Central.",
...
export const historyManDialogue = [
  "Ah, Yosh, always so direct. Fine, I'll start with his latest masterpiece. Josh is currently defining the digital drive as a Senior Front End Software Engineer at Ford. He’s been developing responsive applications for Ford and Lincoln, mastering Vanilla JS, Next.js, and React. He’s collaborating globally to align perfect UIs with brand guidelines and championing accessibility standards like WCAG 2.1. He ensures every interaction is seamless, effectively manufacturing the future of automotive web experiences.",
  'Digging deeper, are we? Very well. Before Ford, there was Sion Central. Josh wasn’t just any developer; he was the Senior Front End Developer who led the charge on a comprehensive design system using Storybook. This wasn’t just about making things pretty—it ensured smooth collaboration across design, development, product, and marketing teams. He even reduced project vulnerabilities from 57 to just 2 and executed a seamless migration from Webpack 4 to Webpack 5. Oh, and don’t forget the end-to-end testing with Cypress. If you’re looking for reliability, Josh was your guy.',
