export const characters = [
  ...
  {
    id: 5,
    image: '/mediaplayerman.webp',
    name: 'Media Man',
    isActive: false,
    isSelected: false,
    page: '/juke-box',
    desc: `He controls Josh's AI-generated music videos, remixing and claiming it as his own in a neon-lit studio filled with high-tech instruments. The studio pulses with rhythms and melodies, challenging the notion of authorship. As the beats echo through the chamber, he questions whether music created with AI truly belongs to Josh, keeping the compositions under his control.`
  },
  {
    id: 6,
    image: '/moshman.webp',
